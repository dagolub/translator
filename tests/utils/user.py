...
async def create_random_user(db: Session) -> Optional[User]:
    email = random_email()
...
def create_user(
    ...
    email = f"dmitriy.golub+{random.choice(range(111111, 999999))}@gmail.com"  # nosec
    password = "superpassword123"  # nosec
